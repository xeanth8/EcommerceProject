...
class __TwigTemplate_b9cdf35507659d7c9931050b760f5fd7f806d7216ac22d554bdf14653f3695f6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<style>
  ...
  .category-card .card-title {
    ...
    font-weight: bold;
    font-size: 16px;
    text-shadow : -4px -3px 7px white, 2px 5px 7px white;
  }
