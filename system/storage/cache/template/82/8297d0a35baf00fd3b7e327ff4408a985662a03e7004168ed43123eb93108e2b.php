...
class __TwigTemplate_649f3e0c42c2bcbba4f23a49a944ada4b10c23d171e1aab56058c93c307460cd extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<style>
  ...
  .category-card .card-title {
    ...
    font-weight: bold;
    font-size: 16px;
    text-shadow : -4px -3px 7px white, 2px 5px 7px white, 2px 5px 7px white;
  }
