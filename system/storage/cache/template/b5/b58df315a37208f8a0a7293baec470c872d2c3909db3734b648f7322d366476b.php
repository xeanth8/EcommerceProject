...
class __TwigTemplate_c2162f86a260a8523ee73744b71b3b041ea62a6389fd89ed82281533352fd916 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<style>
  ...
  .category-card .card-title {
    ...
    font-weight: bold;
    font-size: 16px;
    text-shadow : -4px -3px 7px white, 2px 5px 7px white, -1px 0px 5px white;
  }
